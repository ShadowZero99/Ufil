...
const Image = ({ children, ...restOfAllProps }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("figure", { className: className, children: [(0, jsx_runtime_1.jsxs)("picture", { children: [useAvif && (0, jsx_runtime_1.jsx)("source", { srcSet: srcSetAvif, type: "image/avif", sizes: sizes, media: media }), useWebP && (0, jsx_runtime_1.jsx)("source", { srcSet: srcSetWebp, type: "image/webp", sizes: sizes, media: media }), srcSet.length > 0 && ((0, jsx_runtime_1.jsx)("source", { srcSet: srcSet, type: `image/${originalFileExtension}`, sizes: sizes, media: media })), (0, jsx_runtime_1.jsx)("img", { ...commonProps, ...rest })] }), captionString && (0, jsx_runtime_1.jsx)("figcaption", { dangerouslySetInnerHTML: { __html: captionString } })] }));
};
exports.Image = Image;
